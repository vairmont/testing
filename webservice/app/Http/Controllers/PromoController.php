...
class PromoController extends Controller
{
    ...
    public function recommendationIndex(Request $request) 
    {
    	$rec = OrderDetail::join('product', 'product.id', '=', 'order_detail.product_id')
    				->select(DB::raw('SUM(order_detail.qty) as sales'), 'product.id', 'product.product_name', 'product.promo_price', 'product.price_for_customer', 'product.img_url', 'product.description')
