...
class ProductControllerPOS extends Controller
{
  public function searchProduct (Request $request)
  {
    ...
    ->where('product.product_name', 'like', '%' . $request->keyword . '%')
    ->select(DB::raw('product.id , product.product_name , product.category_id, product_category.name as category_name, product.price_for_customer as price', 'incentive_category.rate'));
