...
class ProductController extends Controller
{
    ...
    ->select(
      DB::raw('product.id , product.product_name , product.category_id, product_category.name as category_name, product.price_for_customer as regular_price, incentive_category.rate , product.img_url, product.description, product.price')
      );
